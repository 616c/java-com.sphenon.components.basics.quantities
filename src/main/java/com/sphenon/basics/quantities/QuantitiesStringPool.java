...
public class QuantitiesStringPool extends StringPoolClass {
    static protected QuantitiesStringPool singleton = null;

    static public QuantitiesStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new QuantitiesStringPool(cc);
        }
        return singleton;
    }
    ...
    protected QuantitiesStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
