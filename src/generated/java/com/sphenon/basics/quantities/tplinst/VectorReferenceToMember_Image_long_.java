...
public class VectorReferenceToMember_Image_long_
    implements ReferenceToMember_Image_long_ReadOnlyVector_Image_long__
{
    private ReadOnlyVector_Image_long_ vector;
    private long                          index;

    public VectorReferenceToMember_Image_long_ (CallContext context, ReadOnlyVector_Image_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_Image_long_)) return false;
        if (((VectorReferenceToMember_Image_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_Image_long_) object).index  != this.index ) return false;
        return true;
    }
