...
public class Factory_Optional_float_ {

    protected Float value;

    public Factory_Optional_float_ (CallContext context) {
        this.value = null;
    }

    public Optional_float_ create (CallContext context) {
        return new Optional_float_(context, this.value);
    }
