...
public class VectorImpl_RichText_long_
  implements Vector_RichText_long_,
             VectorOptimized<RichText>,
             Dumpable,
             ManagedResource
 {
    private java.util.Vector vector;

    protected VectorImpl_RichText_long_ (CallContext context) {
        vector = new java.util.Vector(4);
    }

    static public VectorImpl_RichText_long_ create (CallContext context) {
        return new VectorImpl_RichText_long_(context);
    }

    protected VectorImpl_RichText_long_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    }

    static public VectorImpl_RichText_long_ create (CallContext context, java.util.Vector vector) {
        return new VectorImpl_RichText_long_(context, vector);
    }
    ...
    public RichText get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (RichText) vector.elementAt((int) index);
    ...
    public boolean contains(CallContext context, RichText item) {
        return this.vector.contains(item);
    }

    public boolean removeFirst(CallContext context, RichText item) {
        return this.vector.remove(item);
    }

    public void removeAll(CallContext context, RichText item, VectorOptimized.Notifier<RichText> notifier) {
