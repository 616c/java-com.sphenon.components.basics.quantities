...
public class VectorImpl_DataSource_FileResource_long_
  implements Vector_FileResource_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_FileResource_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_FileResource_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_FileResource_long_(context, vector_source);
    }

    public FileResource get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (FileResource) vector_source.get(context).elementAt((int) index);
    ...
    public FileResource set          (CallContext context, long index, FileResource item) {
        ...
        return (FileResource) vector_source.get(context).set((int) index, item);
    }
    ...
    public FileResource unset        (CallContext context, long index) {
        try {
            return (FileResource) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
