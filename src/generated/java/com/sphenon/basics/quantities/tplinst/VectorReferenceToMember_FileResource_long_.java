...
public class VectorReferenceToMember_FileResource_long_
    implements ReferenceToMember_FileResource_long_ReadOnlyVector_FileResource_long__
{
    private ReadOnlyVector_FileResource_long_ vector;
    private long                          index;

    public VectorReferenceToMember_FileResource_long_ (CallContext context, ReadOnlyVector_FileResource_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_FileResource_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_FileResource_long_)) return false;
        if (((VectorReferenceToMember_FileResource_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_FileResource_long_) object).index  != this.index ) return false;
        return true;
    }
