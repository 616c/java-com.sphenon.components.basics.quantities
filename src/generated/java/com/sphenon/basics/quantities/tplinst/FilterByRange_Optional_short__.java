...
public class FilterByRange_Optional_short__ extends GenericFilterBase<Optional_short_> implements Filter_Optional_short__, FilterByRange {
    ...
    public FilterByRange_Optional_short__ (CallContext context) {
        super(context, target_type == null ? (target_type = TypeManager.get(context, Optional_short_.class)) : target_type);
    ...
    public FilterByRange_Optional_short__ (CallContext context, Short minimum, Short maximum, boolean include_minimum, boolean include_maximum) {
        this(context);
        this.setMinimum(context, minimum);
        this.setMaximum(context, maximum);
