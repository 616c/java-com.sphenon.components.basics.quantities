...
public class VectorImplList_DataSource_FileResource_long_
  implements Vector_FileResource_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_FileResource_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_FileResource_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_FileResource_long_(context, vector_source);
    }

    public FileResource get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (FileResource) vector_source.get(context).get((int) index);
