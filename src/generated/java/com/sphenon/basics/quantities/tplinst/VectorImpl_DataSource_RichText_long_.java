...
public class VectorImpl_DataSource_RichText_long_
  implements Vector_RichText_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_RichText_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_RichText_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_RichText_long_(context, vector_source);
    }

    public RichText get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (RichText) vector_source.get(context).elementAt((int) index);
    ...
    public RichText set          (CallContext context, long index, RichText item) {
        ...
        return (RichText) vector_source.get(context).set((int) index, item);
    }
    ...
    public RichText unset        (CallContext context, long index) {
        try {
            return (RichText) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
