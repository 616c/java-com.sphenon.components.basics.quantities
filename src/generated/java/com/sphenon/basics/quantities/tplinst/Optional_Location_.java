...
public class Optional_Location_ implements Dumpable {

    protected Location value;

    public Optional_Location_ (CallContext context) {
        this.value = null;
    }

    public Optional_Location_ (CallContext context, Location value) {
        this.value = value;
    }

    public Location getValue (CallContext context) {
        return this.value;
    }

    public void setValue (CallContext context, Location value) {
        this.value = value;
    }
