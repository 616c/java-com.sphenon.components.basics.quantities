...
public class VectorImpl_DataSource_Image_long_
  implements Vector_Image_long_, ManagedResource {
    private com.sphenon.basics.data.DataSource<Vector> vector_source;

    public VectorImpl_DataSource_Image_long_ (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        this.vector_source = vector_source;
    }

    static public VectorImpl_DataSource_Image_long_ create (CallContext context, com.sphenon.basics.data.DataSource<Vector> vector_source) {
        return new VectorImpl_DataSource_Image_long_(context, vector_source);
    }

    public Image get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Image) vector_source.get(context).elementAt((int) index);
    ...
    public Image set          (CallContext context, long index, Image item) {
        ...
        return (Image) vector_source.get(context).set((int) index, item);
    }
    ...
    public Image unset        (CallContext context, long index) {
        try {
            return (Image) vector_source.get(context).remove((int) index);
        } catch (ArrayIndexOutOfBoundsException e) {
