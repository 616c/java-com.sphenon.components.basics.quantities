...
public class VectorIteratorImpl_Image_long_
    implements IteratorItemIndex_Image_long_,
               Cloneable
{
    private ReadOnlyVector_Image_long_ vector;
    private long current_index;

    public VectorIteratorImpl_Image_long_ (CallContext context, ReadOnlyVector_Image_long_ vector) {
        this.vector = vector;
    ...
    public Image getCurrent    (CallContext context) throws DoesNotExist {
        return vector.get(context, this.current_index);
    }

    public Image tryGetCurrent (CallContext context) {
    ...
    public Reference_Image_ getReferenceToCurrent (CallContext context) throws DoesNotExist {
        return vector.getReference(context, this.current_index);
    }

    public Reference_Image_ tryGetReferenceToCurrent (CallContext context) {
        return vector.tryGetReference(context, this.current_index);
    }

    public VectorIteratorImpl_Image_long_ clone(CallContext context) {
        try {
            return (VectorIteratorImpl_Image_long_) super.clone();
