...
public class Factory_Optional_String_ {

    protected String value;

    public Factory_Optional_String_ (CallContext context) {
        this.value = null;
    }

    public Optional_String_ create (CallContext context) {
        return new Optional_String_(context, this.value);
    }
