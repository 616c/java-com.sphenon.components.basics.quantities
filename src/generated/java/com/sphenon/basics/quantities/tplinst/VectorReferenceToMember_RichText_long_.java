...
public class VectorReferenceToMember_RichText_long_
    implements ReferenceToMember_RichText_long_ReadOnlyVector_RichText_long__
{
    private ReadOnlyVector_RichText_long_ vector;
    private long                          index;

    public VectorReferenceToMember_RichText_long_ (CallContext context, ReadOnlyVector_RichText_long_ vector, long index) {
        this.vector = vector;
        this.index  = index;
    ...
    public ReadOnlyVector_RichText_long_ getContainer (CallContext context) {
        return this.vector;
    }
    ...
    public boolean equals (Object object) {
        ...
        if (! (object instanceof VectorReferenceToMember_RichText_long_)) return false;
        if (((VectorReferenceToMember_RichText_long_) object).vector != this.vector) return false;
        if (((VectorReferenceToMember_RichText_long_) object).index  != this.index ) return false;
        return true;
    }
