...
public class FilterByRegExp_Image_ extends GenericFilterBase<Image> implements FilterByExpression_Image_ {
    ...
    public FilterByRegExp_Image_ (CallContext context) {
        super(context, target_type == null ? (target_type = TypeManager.get(context, Image.class)) : target_type);
    }

    public FilterByRegExp_Image_ (CallContext context, String regexp) throws PatternSyntaxException {
        this(context);
    ...
    public boolean matches (CallContext context, Image object) {
    ...
    static public FilterByRegExp_Image_ newInstance(CallContext context) {
        return (FilterByRegExp_Image_) Factory_Filter_Image_.construct(context);
    }
}
