...
public class FilterByRange_Optional_long__ extends GenericFilterBase<Optional_long_> implements Filter_Optional_long__, FilterByRange {
    ...
    public FilterByRange_Optional_long__ (CallContext context) {
        super(context, target_type == null ? (target_type = TypeManager.get(context, Optional_long_.class)) : target_type);
    ...
    public FilterByRange_Optional_long__ (CallContext context, Long minimum, Long maximum, boolean include_minimum, boolean include_maximum) {
        this(context);
        this.setMinimum(context, minimum);
        this.setMaximum(context, maximum);
