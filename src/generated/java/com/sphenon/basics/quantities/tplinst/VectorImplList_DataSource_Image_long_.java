...
public class VectorImplList_DataSource_Image_long_
  implements Vector_Image_long_, Changing, ManagedResource {
    ...
    protected VectorImplList_DataSource_Image_long_ (CallContext context, DataSource_List_ vector_source) {
    ...
    static public VectorImplList_DataSource_Image_long_ create (CallContext context, DataSource_List_ vector_source) {
        return new VectorImplList_DataSource_Image_long_(context, vector_source);
    }

    public Image get          (CallContext context, long index) throws DoesNotExist {
        try {
            return (Image) vector_source.get(context).get((int) index);
