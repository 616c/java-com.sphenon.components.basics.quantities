...
public class Factory_Optional_int_ {

    protected Integer value;

    public Factory_Optional_int_ (CallContext context) {
        this.value = null;
    }

    public Optional_int_ create (CallContext context) {
        return new Optional_int_(context, this.value);
    }
