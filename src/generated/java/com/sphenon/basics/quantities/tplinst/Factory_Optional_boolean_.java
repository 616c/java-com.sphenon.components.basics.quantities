...
public class Factory_Optional_boolean_ {

    protected Boolean value;

    public Factory_Optional_boolean_ (CallContext context) {
        this.value = null;
    }

    public Optional_boolean_ create (CallContext context) {
        return new Optional_boolean_(context, this.value);
    }
